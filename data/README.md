# Retromark Data Directory

This directory stores the database and configuration files for Retromark.

## Expected Files

When running Retromark, the following files will be created in this directory:
...
- These files are automatically created when you run Retromark
